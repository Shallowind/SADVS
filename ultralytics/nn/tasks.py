...
# 此处进行了修改，添加了模块DCNV2, DCNV3
from ultralytics.nn.modules import (C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify,
                                    Concat, Conv, ConvTranspose, Detect, DWConv, DWConvTranspose2d, Ensemble, Focus,
                                    GhostBottleneck, GhostConv, Segment, DCNV2, DCNV3, BiFormerBlock, C2f_BiLevelRoutingAttention)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # 此处进行了修改，注册了模块DCNV2, DCNV3
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, DCNV2, DCNV3, BiFormerBlock, C2f_BiLevelRoutingAttention):
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            # 此处进行了修改，注册了模块DCNV2, DCNV3
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, DCNV2, DCNV3, C2f_BiLevelRoutingAttention, BiFormerBlock):

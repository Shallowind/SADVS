...
class ToolBar(QWidget):
    ...
    def __initWidget(self):
        ...
        self.themeButton.setToolTip(self.tr('主题'))
        self.supportButton.setToolTip(self.tr('支持'))
        self.feedbackButton.setToolTip(self.tr('发送'))
        ...
        self.feedbackButton.clicked.connect(
            lambda: QDesktopServices.openUrl(QUrl(MY_URL)))

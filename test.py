...
class Pyqt5Window:
    ...
    def startIdentifyThread(self):
        ...
        self.model_path = ['D:/DaChuang/项目资料/yolov5_pyqt5-master/yolov5_pyqt5-master/weights/yolov5s.pt', '0']
        self.camera_thread = CameraDetectionThread(self.model_path, self.ui.camera_2)
        self.camera_thread.start()

    def startIdentify(self):
        model_path = 'D:/DaChuang/项目资料/yolov5_pyqt5-master/yolov5_pyqt5-master/weights/yolov5s.pt'
        print("1")
        # detect.run(source=self.selected_path, weights=model_path, show_label=self.ui.camera_2, save_img=True)
        detect.run(source=0, weights=model_path, show_label=self.ui.camera_2, save_img=False, use_camera=True)
        print("2")
